...
namespace IA_MLP
{
    ...
    {
        public static void CorrerConMisDatos()
        {
            ...
            Console.WriteLine("Cargando los datos del dataset");
            string data = System.IO.File.ReadAllText(@"C:\Users\fedeb\Downloads\Datasets\Datasets\dataset1000validacion10.txt").Replace("\r", "");
            ...
            ShowMatrix(trainData, 4, 0, true);
            Console.WriteLine("Test data:");
            ShowMatrix(testData, 4, 0, true);
        ...
        public static void Correr_con_mi_red_unicapa_oculta()
        {
            Console.WriteLine("\nBegin neural network back-propagation demo");
            ...
            Console.WriteLine("Creating a " + numInput + "-" + numHidden + "-" + numOutput + " neural network");
            Perceptron_e_o_s nn = new Perceptron_e_o_s(numInput, numHidden, numOutput);
            ...
            Console.WriteLine("\nStarting training");
            double[] weights = nn.Entrenar(trainData, maxEpochs, learnRate, momentum);
            Console.WriteLine("Done");
            Console.WriteLine("\nFinal neural network model weights and biases:\n");
            ShowVector(weights, 2, 10, true);
        ...
        public static void Correr_con_mi_red_de_dos_capas_ocultas()
        {
            Console.WriteLine("\nBegin neural network back-propagation demo");
            ...
            Console.WriteLine("\nGenerating " + numRows + " artificial data items with " + numInput + " features");
            double[][] allData = MakeAllDataFor2Layer(numInput, numHidden1, numHidden2, numOutput, numRows, seed);
            Console.WriteLine("Done");
            ...
            Perceptron_e_o_o_s nn = new Perceptron_e_o_o_s(numInput, numHidden1, numHidden2, numOutput);
